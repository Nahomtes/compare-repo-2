...
const LargerScreenNB = ({
  ...
  function getPCDNButton(navButton) {
    return navButton.emphasize ? (
      <Button
        key={navButton.labelText}
        disableRipple
        weight="medium"
        className={cn(classes.logotype, classes.pcdnButton)}
            ...
            navButton.type === 'dropdown' ? (
              ...
              >
                <NavLink
                  ...
                  to={navButton.link ? navButton.link : '/'}
                  onClick={() =>
                    handleButtonClickEvent(`${navButton.labelText}`)
                  }
                >
                  {navButton.labelText}
                </NavLink>
...
const styles = () => ({
  ...
  logotype: props => ({
    whiteSpace: 'nowrap',
    color: '#FFFFFF',
    fontFamily: props.navBarstyling.global.fontFamily
  ...
  toolbar: props => ({
    minHeight: props.navBarstyling.global.height
      ...
      : '39px',
    paddingRight: props.navBarstyling.global.paddingRight
      ? props.navBarstyling.global.paddingRight
      : '45px',
    paddingLeft: props.navBarstyling.global.paddingLeft
      ? props.navBarstyling.global.paddingLeft
      : '45px',
    alignItems: props.navBarstyling.global.alignItems
      ? props.navBarstyling.global.alignItems
      : 'flex-start',
